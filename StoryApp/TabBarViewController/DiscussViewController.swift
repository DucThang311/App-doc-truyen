...
class DiscussViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    private func setupUI() {
        ...
        tableView.register(UITableViewCell.self, forCellReuseIdentifier: "DiscussionCell")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let dateStr = discussion.createdAt.prefix(10)
        cell.textLabel?.numberOfLines = 0
        cell.textLabel?.text = "\(discussion.username) - \(dateStr)\n\(discussion.message)"
        return cell
    }
